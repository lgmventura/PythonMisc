        ...
        for clip in bpy.data.movieclips:
            for track in clip.tracking.tracks:
                while True:
                    ...
                    for k in range(1, filterW):
                        f = frameno - k
                        if (f < 0):
                            f = 0
                        clip.tracking.stabilization.target_position[0] = clip.tracking.stabilization.target_position[0] + coords[0][f]/filterW
                        clip.tracking.stabilization.target_position[1] = clip.tracking.stabilization.target_position[1] + coords[1][f]/filterW
                    frameno += 1
