...
def make_transparent(pil_img_data, colour_rgb):
    
    # Convert image to RGBA (if not already)
    img = pil_img_data.convert("RGBA")
...
def make_transparent_in_folder(input_folder, output_folder, colour_rgb=[255, 255, 255]):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".png"):
            ...
            img = make_transparent(img, colour_rgb)
